...
public class ExamenController implements Initializable {
    ...
    EventHandler<ActionEvent> btnSalir = (ActionEvent event) -> {
        ...
        botonsalir.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                dialog.close();
                InterfazAnalizadorLexicoController.getExamenController().reiniciarExamen(event);
    ...
    public ArrayList<Pregunta> leerPreguntas(String file) {
        ...
        try {
            ////////////////
            InputStream inputFile = getClass().getResourceAsStream("/Modulo_II/Submodulos/" + file);
    ...
    private void irinicio() {
        ...
        InterfazInicioController.getController().irA(0.0);
    }
}
